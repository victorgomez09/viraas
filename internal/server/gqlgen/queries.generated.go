...
type QueryResolver interface {
	...
	GetAppTasks(ctx context.Context, id string) ([]*internal.AppTask, error)
	...
	GetNode(ctx context.Context, id string) (*internal.Node, error)
}
...
func (ec *executionContext) field_Query_getAppTasks_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
...
func (ec *executionContext) field_Query_getPlugin_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["name"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("name"))
		arg0, err = ec.unmarshalNPluginName2githubᚗcomᚋvictorgomez09ᚋviraasᚋinternalᚐPluginName(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_health(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOHealth2ᚖgithubᚗcomᚋvictorgomez09ᚋviraasᚋinternalᚐHealth(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_getAppTasks(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_getAppTasks(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetAppTasks(rctx, fc.Args["id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.([]*internal.AppTask)
	fc.Result = res
	return ec.marshalNAppTask2ᚕᚖgithubᚗcomᚋvictorgomez09ᚋviraasᚋinternalᚐAppTaskᚄ(ctx, field.Selections, res)
}

func (ec *executionContext) fieldContext_Query_getAppTasks(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			switch field.Name {
			case "message":
				return ec.fieldContext_AppTask_message(ctx, field)
			case "state":
				return ec.fieldContext_AppTask_state(ctx, field)
			case "desiredState":
				return ec.fieldContext_AppTask_desiredState(ctx, field)
			case "timestamp":
				return ec.fieldContext_AppTask_timestamp(ctx, field)
			case "appId":
				return ec.fieldContext_AppTask_appId(ctx, field)
			case "app":
				return ec.fieldContext_AppTask_app(ctx, field)
			case "nodeId":
				return ec.fieldContext_AppTask_nodeId(ctx, field)
			case "node":
				return ec.fieldContext_AppTask_node(ctx, field)
			case "name":
				return ec.fieldContext_AppTask_name(ctx, field)
			case "error":
				return ec.fieldContext_AppTask_error(ctx, field)
			case "exitCode":
				return ec.fieldContext_AppTask_exitCode(ctx, field)
			}
			return nil, fmt.Errorf("no field named %q was found under type AppTask", field.Name)
		},
	}
	defer func() {
		if r := recover(); r != nil {
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Query_getAppTasks_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return
	}
	return fc, nil
...
func (ec *executionContext) _Query_listPlugins(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNPlugin2ᚕᚖgithubᚗcomᚋvictorgomez09ᚋviraasᚋinternalᚐPluginᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_getPlugin(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*internal.Plugin)
	fc.Result = res
	return ec.marshalNPlugin2ᚖgithubᚗcomᚋvictorgomez09ᚋviraasᚋinternalᚐPlugin(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_nodes(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNNode2ᚕᚖgithubᚗcomᚋvictorgomez09ᚋviraasᚋinternalᚐNodeᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_getNode(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetNode(rctx, fc.Args["id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	for i, field := range fields {
		...
		case "getAppTasks":
			...
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				...
				res = ec._Query_getAppTasks(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&invalids, 1)
				}
				return res
