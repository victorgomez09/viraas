...
func (ec *executionContext) field_Mutation_createApp_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNAppInput2githubᚗcomᚋvictorgomez09ᚋviraasᚋinternalᚐAppInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) field_Mutation_setAppRoute_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["route"]; ok {
		...
		arg1, err = ec.unmarshalORouteInput2ᚖgithubᚗcomᚋvictorgomez09ᚋviraasᚋinternalᚐRouteInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
